...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "                       Supports PPO or DQN; required for --rl and --proximity"
            echo ""
            ...
            echo "  $0 --proximity 250 --model rl_module/trained_models/.../ppo_traffic_final.zip --gui --security --edge --steps 1000"
            echo ""
